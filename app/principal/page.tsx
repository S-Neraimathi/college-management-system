...
//                 setChangeRequests(requestsData); // Assuming you have a state variable to store requests
...
//                                 </td>
//                                 <td>
//                                     <button onClick={() => updateApproval('Principal', "approved", request.id)}>Approve Principal</button>
//                                 </td>
//                                 <td>
//                                     <button onClick={() => updateApproval('Principal', "rejected", request.id)}>Reject Principal</button>
//                                 </td>
//                             </tr>
//                         ))}
//                     </tbody>
...
// export default TableForPrincipal;
